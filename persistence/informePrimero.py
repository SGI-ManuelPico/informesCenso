...
class InformePrimero:
    ...
    def crearArchivoPrimero(self, ws, df_fila):
        ...
        ws['T3'] = df_fila['Encuestador']
        ws['A8'] = df_fila['Departamento']
        ws['N8'] = df_fila['Municipio']
        ws['U8'] = df_fila['Vereda/Centro Poblado']
        ws['A10'] = str(self.df_enc['Coordenada Norte'][0]) + ',' + str(self.df_enc['Coordenada Este'][0])
        ...
        print(f"¿Cuál es la cantidad de ingresos recibidos por la actividad?: {actividad5}") 
        ...
        if pd.notna(actividad9):
            if actividad9 == 'Sí':
                ...
                ws['Y53'] = 'X'
            elif actividad9 == 'Otro':
                ws['U55'] = 'X'
                ws['V55'] = df_fila['¿En qué lugares?']
            else:
